              ...
              <Link key={s.title} href={s.href} className="block">
                <Reveal delay={i * 0.06}>
                  <div className="group bg-charcoal-600 border border-charcoal-500 rounded-2xl p-8 hover:border-teal-500/30 transition-all h-full">
                    <h3 className="font-display text-xl text-cream-100 mb-3 group-hover:text-teal-400 transition-colors">
                      {s.title}
                    </h3>
                    <p className="text-charcoal-300 leading-relaxed text-sm mb-4">{s.desc}</p>
                    <span className="text-teal-400 font-semibold text-sm inline-flex items-center gap-1.5 group-hover:text-teal-300 transition-colors">
