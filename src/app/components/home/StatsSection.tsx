...
export default function StatsSection() {
  return (
    <>
      ...
      {/* Research Banner */}
      <Link href="/blog/wordpress-vs-nextjs-ai-citations-health-study" className="block bg-teal-600 border-y border-teal-700/40 group hover:bg-teal-700 transition-colors">
        <div className="max-w-[1300px] mx-auto px-8 py-5 flex items-center justify-between gap-6 max-md:px-6">
          <div className="flex items-center gap-4 min-w-0">
            <span style={body} className="text-[0.65rem] font-semibold uppercase tracking-widest text-white bg-white/15 px-2.5 py-1 rounded-full shrink-0">New Research</span>
            <p style={body} className="text-[0.9rem] text-white/90 truncate">
              We tested 99 health websites across ChatGPT, Claude & Google AI — <span className="text-white font-medium">Next.js sites captured 70% of all AI citations</span>
            </p>
          </div>
          <span style={body} className="text-[0.8rem] text-white font-medium whitespace-nowrap flex items-center gap-1.5 shrink-0">
