    ...
    <section id="contact" className="py-32 px-8 text-[#FAF6F0] text-center relative overflow-hidden cta-gradient max-md:py-20 max-md:px-6">
      ...
      <Reveal delay={0.25} className="relative z-10 mt-12">
        ...
        <div
          ...
          data-url="https://calendly.com/admin-driftlss/15-minute-discovery-call?hide_gdpr_banner=1&hide_event_type_details=1&hide_landing_page_details=1&background_color=faf6f0&text_color=1a1a18&primary_color=0d9488"
