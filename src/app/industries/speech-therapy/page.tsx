  ...
  const faqs = [
    {
      ...
      a: "Typically $3,500–$8,000 depending on the number of service pages, teletherapy booking integration, and AI chatbot features. We'll give you a clear quote after a free 15-minute call.",
    },
    {
