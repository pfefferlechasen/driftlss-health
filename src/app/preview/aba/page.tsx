        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] as const }}>
            <div className="relative">
              {customImages.hero ? (
                <img src={customImages.hero} alt="Child in therapy" className="rounded-2xl shadow-2xl w-full object-cover aspect-[4/3]" />
              ) : (
                <div className="rounded-2xl shadow-2xl w-full aspect-[4/3] relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${accentLight} 0%, #DDD6FE 50%, #C4B5FD 100%)` }}>
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                    ...
                    <p className="text-sm text-purple-500/70">Upload a photo of your clinic, team, or a child in therapy</p>
                  </div>
                </div>
              )}
      ...
      <section id="about" className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] as const }}>
            <div className="relative">
              {customImages.about ? (
                <img src={customImages.about} alt="Therapy session" className="rounded-2xl shadow-lg w-full object-cover aspect-[4/3]" />
              ) : (
                <div className="rounded-2xl shadow-lg w-full aspect-[4/3] relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${accentLight} 0%, #F5F0FF 50%, #EDE9FE 100%)` }}>
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                    <div style={{ background: accent }} className="w-16 h-16 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
      ...
      <footer className="py-12 px-6 bg-gray-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <p className="text-gray-500 text-sm">Built by <a href="https://driftlss.com" className="text-purple-400 hover:text-white transition">Driftlss</a></p>
          </div>
        </div>
      </footer>
    </main>
