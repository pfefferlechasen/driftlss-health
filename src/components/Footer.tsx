      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-charcoal-600 pt-8 flex flex-col items-center gap-4 text-center">
          <div className="flex items-center gap-6">
            ...
            <p className="text-charcoal-400 text-sm">Appleton, WI</p>
            ...
            <a href="https://www.pinterest.com/driftlss/" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="text-charcoal-400 hover:text-teal-300 transition-colors">
            ...
            <a href="https://www.instagram.com/driftlssagency/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-charcoal-400 hover:text-teal-300 transition-colors">
